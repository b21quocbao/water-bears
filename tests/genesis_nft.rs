...
fn test() {
    ...
    let (public_key_2, _private_key_2, account_component_2) = ledger.new_allocated_account();
    ...
    //     .lock_fee_from_faucet()
    //     .call_method(stake_pool_component, "create_id", ())
    //     .deposit_batch(account_component_2)
    //     .build();
    // let receipt = ledger.execute_manifest(
    //     manifest,
    //     vec![NonFungibleGlobalId::from_public_key(&public_key_2)],
    // );
    // receipt.expect_commit_success();
